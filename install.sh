...
mkdir -p /var/gime
sqlite3 -batch /var/gime/data.db "create table if not exists saved_data(keyword varchar(64) not null, label varchar(64), data varchar(1024), unique(keyword,label))";
